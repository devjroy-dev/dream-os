...
async function main() {
  ...
  T('1.4 LINES 67; the nine hashes literal (B56 to B62, B67, B68); each byte hashes to its literal', DL.LINES && Object.keys(DL.LINES).length === 67 && Object.keys(NINE).every((k) => DL.LINE_HASHES[k] === NINE[k] && sha(DL.LINES[k] || '') === NINE[k]));
