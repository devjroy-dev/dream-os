...
async function main() {
  ...
  T('1.4 LINES 67; the nine hashes literal (B56 to B62, B67, B68); each byte hashes to its literal', DL.LINES && Object.keys(DL.LINES).length === 79 /* RE-PINNED (CE-45 LCV-14, P7 cut 4 fix, labelled): 75 → 79, B80 to B83; b109 holds them */ /* RE-PINNED (CE-45 LCV-14, P7 cut 4, labelled): 67 → 75, the eight lookup bytes; b108 holds them */ && Object.keys(NINE).every((k) => DL.LINE_HASHES[k] === NINE[k] && sha(DL.LINES[k] || '') === NINE[k]));
