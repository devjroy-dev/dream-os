...
(async () => {
  ...
  T('4.2 the seat that stages and approves (relaySeat.js, coupleDrafts.js) is untouched: the draft keeps his approved bytes', execSync('git diff --quiet 727ed5c -- src/lib/vendor/relaySeat.js src/lib/vendor/coupleDrafts.js; echo $?', { cwd: ROOT, encoding: 'utf8' }).trim() === '0');
