...
async function main() {
  ...
  T('3.2 no founder byte moved: doorLines.js is not in this cut and LINES still holds 41', !man.includes(DLf) && Object.keys(DL.LINES).length === 52); // RE-PINNED (CE-45 LCV-12, P7 2a): LINES 52
