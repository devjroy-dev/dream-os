...
async function main() {
  ...
  T('3.2 no founder byte moved: doorLines.js is not in this cut and LINES still holds 41', !man.includes(DLf) && Object.keys(DL.LINES).length === 67 /* RE-PINNED (CE-45 LCV-14, P7 cut 3, labelled): 67 since B56 to B62, B67, B68, his (B60 carried, unspoken); b106 holds them */); // RE-PINNED (CE-45 LCV-13, P7 2b, labelled): LINES 58 // RE-PINNED (CE-45 LCV-12, P7 2a): LINES 52
