...
async function main() {
  ...
  T('5.3 ONE vendor byte added, B36, his; LINES holds 41 (38 then; B37 to B39 since P6b, CE-45 LCV-11); the home is nearestName, called from exactly one offer helper', Object.keys(DL.LINES).length === 41 && (src(WDf).replace(/^\s*\/\/.*$/gm, '').match(/nearestName\(/g) || []).length === 2);
  ...
  const HS = [undefined, null, 0, '', 'x', [], {}, trap, { asked: 'B36' }, { asked: 'B36', acts: [money('booking_confirmed', 'A')] }, { asked: 'B36', acts: [money('booking_confirmed', 'A')], candidate_id: 7 }, { asked: 'B36', acts: [money('booking_confirmed')], candidate_id: 'l-isha' }, { asked: 'B36', acts: [{ act: 'block_date' }], candidate_id: 'l-isha' }, { asked: 'B36', acts: [money('booking_confirmed', 'Isha Walk Fourteen')], candidate_id: 'l-isha' }, { asked: 'B36', acts: [trap], candidate_id: 'l-isha' }];
  let t6 = 0; let ok6 = 0;
