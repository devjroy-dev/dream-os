...
async function main() {
  ...
  T('1.1 LINES 75: the eight of his (B69 to B74, B78, B79), each byte its hash literal; B78 has NO full stop', Object.keys(DL.LINES).length === 81 /* RE-PINNED (CE-45 LCV-15, LSP_2, labelled): 79 to 81, B84 and B85, his (R-45.16, the screenshot save); b112 holds them */ /* RE-PINNED (CE-45 LCV-14, P7 cut 4 fix, labelled): 79 since B80 to B83, his; b109 holds them */ && Object.keys(EIGHT).every((k) => DL.LINE_HASHES[k] === EIGHT[k] && sha(DL.LINES[k] || '') === EIGHT[k]) && !DL.LINES.B78.endsWith('.'));
