...
async function main() {
  ...
  await mut('9.12 M12 validNote without its guard throws on a hostile note (reddens 8.1)', WDf,
    // ANCHOR RE-AIMED (the third B-2 cut): the return line gained candidate_id; what M12 proves is unchanged. RE-AIMED AGAIN (CE-45 LCV-11, P6b): it gained draft_id; and again (the P6b fix cut, F-44.123): said.
