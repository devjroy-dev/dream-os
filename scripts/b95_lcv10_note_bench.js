...
async function main() {
  ...
  await mut('9.12 M12 validNote without its guard throws on a hostile note (reddens 8.1)', WDf,
    // ANCHOR RE-AIMED (the third B-2 cut): the return line gained candidate_id; what M12 proves is unchanged.
    [["    return { asked: n.asked, acts, tries, direction: directionOf(acts[0].act), lead_id: typeof n.lead_id === 'string' ? n.lead_id : null, package_id: typeof n.package_id === 'string' ? n.package_id : null, ...(typeof n.candidate_id === 'string' ? { candidate_id: n.candidate_id } : {}) };\n  } catch (_e) { return null; }", "    return { asked: n.asked, acts, tries, direction: directionOf(acts[0].act), lead_id: typeof n.lead_id === 'string' ? n.lead_id : null, package_id: typeof n.package_id === 'string' ? n.package_id : null, ...(typeof n.candidate_id === 'string' ? { candidate_id: n.candidate_id } : {}) };\n  } finally { /* guard removed */ }"]], [],
