...
async function main() {
  ...
  T('7.3 the ONE vendor byte added is B35, his; every other line of doorLines.js LINES is as it was (the hashes of the rest unchanged)', Object.keys(DL.LINES).length === 58 && /* RE-PINNED (CE-45 LCV-13, P7 2b, labelled): 58 since B48 to B53, his; b105 holds them */ // 38 since the third B-2 cut (B36); 41 since P6b (B37, B38, B39); 52 since P7 2a (B40 to B46, B54, B75 to B77, his; CE-45 LCV-12)
