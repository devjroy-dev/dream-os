...
function exits(DL, LH, GLITCH) {
  ...
  return [
    ...
    { why: 'lookup', message: 'Give me my total owed', ear: earOf(req([{ act: 'tally' }], 'search')), is: (r) => r === DL.LINES.B34, byte: 'B34', label: 'a lookup the door does not answer (tally), since cut four' },
