...
async function main() {
  ...
  T('2.2 the examples the door may show TODAY are exactly the seven: the chair\'s four, example 10 since P6b, example 4 since P7 2a and example 5 since P7 2b', JSON.stringify(coveredEx) === JSON.stringify(['The Sharma booking is confirmed', 'The advance came in today for the Kapoor booking', 'Block 20 March, personal', 'Move the Verma shoot to 22 November', 'Raise the invoice for the Bose wedding', 'Add a new lead, haldi shoot on 3 January', 'Send a message to my client asking for the advance']));
  ...
  T('2.4 the draw is random: all twenty-one pairs of the seven appear (fifteen of six until P7 2b, ten of five until P7 2a; re-pinned CE-45 LCV-13, labelled)', seenPairs.size === 21);
