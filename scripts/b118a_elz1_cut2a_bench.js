...
(async () => {
  ...
  T('4.4 V9 to V16 ride cut 2b: the pick lines are untouched here', DL.LINES.B31 === 'Which package? Yours are: {list}.' && DL.LINES.B8.startsWith('Two clients are called {name}'));
