...
async function main() {
  ...
  T('2.1 COVERED is ten; NEEDS_CLIENT names the acts that must name a client, and block_date and unblock_date are not among them', WD.COVERED.length === 10 && ['block_date', 'unblock_date', 'book_event'].every((a) => WD.COVERED.includes(a)) && !WD.NEEDS_CLIENT.includes('block_date') && !WD.NEEDS_CLIENT.includes('unblock_date') && WD.NEEDS_CLIENT.includes('book_event') && WD.NEEDS_CLIENT.includes('lead'));
