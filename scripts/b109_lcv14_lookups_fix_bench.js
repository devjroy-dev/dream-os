...
async function main() {
  ...
  T('1.1 LINES 79: B80 to B83 his, each byte its hash literal; B83 is B81\'s singular, its own key', Object.keys(DL.LINES).length === 83 /* RE-PINNED (CE-45 ELZ-1 cut 2b, labelled): B86 and B87 his (F-44.175's stopgap), LINES 83 */ /* RE-PINNED (CE-45 LCV-15, LSP_2, labelled): 79 to 81, B84 and B85, his (R-45.16, the screenshot save); b112 holds them */ && Object.keys(FOUR).every((k) => DL.LINE_HASHES[k] === FOUR[k] && sha(DL.LINES[k] || '') === FOUR[k]));
