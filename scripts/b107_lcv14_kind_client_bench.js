...
async function main() {
  ...
  sec('4 · THE LAWS');
  {
    ...
    T('4.3 doorLines.js is 69f4b99\'s blob: no byte moved (LINES 67); listenerDoor.js is f24ffd9\'s: no listener byte (the ruling)', blob(DLf) === 'f41dd59d314d79bc896b370d3dd1d6f3cc6ff357' && blob(LDf) === '6d86a8ffd2e15d865e66d65023b4b902fea93693' && Object.keys(DL.LINES).length === 67);
