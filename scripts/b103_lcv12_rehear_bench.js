...
async function main() {
  ...
  T('6.2 no founder byte moved: doorLines.js is not in this cut and LINES still holds 41; no prompt byte moved: SYSTEM and EAR_TOOL as at 541f145', !man.includes(DLf) && Object.keys(DL.LINES).length === 41 && sha(LD.SYSTEM) === '90163dbe1889ee33f4b505b3b4e1aecfe1f853a2ee19376ebb894bb6aff75fb2' && sha(JSON.stringify(LD.EAR_TOOL)) === '4f1d9d7778ac31302483b758b7400f94dc403741b876adefe350d9502f7d2f61');
