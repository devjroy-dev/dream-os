...
async function main() {
  ...
  T('6.2 LINES holds 58: the six 2b bytes his, each its hash literal; nothing else minted', Object.keys(DL.LINES).length === 58 && Object.keys(SIX).every((k) => DL.LINE_HASHES[k] === SIX[k] && sha(DL.LINES[k]) === SIX[k]));
