...
async function main() {
  ...
  T('6.2 LINES holds 58: the six 2b bytes his, each its hash literal; nothing else minted', Object.keys(DL.LINES).length === 67 /* RE-PINNED (CE-45 LCV-14, P7 cut 3, labelled): 67 since B56 to B62, B67, B68, his (B60 carried, unspoken); b106 holds them */ && Object.keys(SIX).every((k) => DL.LINE_HASHES[k] === SIX[k] && sha(DL.LINES[k]) === SIX[k]));
