...
(async () => {
  ...
  T('1.4 engine.js is the couple lane alone: 820 lines or fewer, one exported name', en.split('\n').length <= 820 && JSON.stringify(Object.keys(require(P(EN)))) === '["runCoupleAgenticTurn"]');
