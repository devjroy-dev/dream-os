...
async function main() {
  ...
  T('6.3 LINES holds 41 (B31, B33 from this cut, B36 from the third; B37 to B39 from P6b, CE-45 LCV-11, his); F-44.118\'s floor is present, scoped by R-44.41 (b99 holds it)', Object.keys(DL.LINES).length === 67 /* RE-PINNED (CE-45 LCV-14, P7 cut 3, labelled): 67 since B56 to B62, B67, B68, his (B60 carried, unspoken); b106 holds them */ /* P7 2b (CE-45 LCV-13, labelled): 58 since B48 to B53 */ /* P7 2a: 52 since B40 to B46, B54, B75 to B77 */ && /saidKey\.includes/.test(src(WDf)));
