...
## 2c · F-41.48 — THE WRITTEN AGREEMENT, DERIVED AT THE CONTRACT

**Meta Platform Terms §5.a.i requires a Service Provider to "first agree **in writing**"; a
support article is not an agreement.** So the clause below is derived at Anthropic's **Commercial
Terms of Service** (`anthropic.com/legal/commercial-terms`), read 2026-09-08 — the contract TDW
accepted at Console signup, not the help centre.

**§B, Customer Content** — quoted:

> *As between the parties and to the extent permitted by applicable law, Anthropic agrees that
> Customer (a) retains all rights to its Inputs, and (b) owns its Outputs. … **Anthropic may not
> train models on Customer Content from Services.** "Inputs" means submissions to the Services by
> Customer or its Users and "Outputs" means responses generated by the Services to Inputs (Inputs
> and Outputs together are "Customer Content").*

**Three things this settles and one it does not.**

- **It is contractual, not policy.** *"may not train"* is a prohibition on Anthropic in an
  agreement, capable of being produced to Meta under §5.a.iv.
- **The definition reaches everything TDW sends.** Inputs are submissions by Customer *or its
  Users*; Outputs are the responses. Victor's prompts and replies are both inside it.
- **The artefact is the Console acceptance** — TDW's assent to these Terms at account creation.
  That, plus this clause, is what §5.a.iv's *"proof of written agreements"* would be answered
  with.

**What it does NOT settle, and this matters.** §5.a.i's test is **broader than training**: the
Service Provider must agree to process Platform Data *"solely for you and at your direction …
and for no other individual or entity and for no other purpose, including for the Service
Provider's own purposes."* §B addresses **training and ownership**. The general
processing-purpose commitment would live in **Anthropic's Data Processing Addendum**, incorporated
at §C where PII is submitted — **and this seat has not read the DPA.** Owed before F-41.48 is
called closed for Anthropic.

**One variance worth recording.** An archived version of these Terms reads *"may not train models
on Customer Content from **paid** Services."* The current text reads *"from Services."* The
current wording is broader. Noted so a later reader comparing versions is not confused.

**Conflict of interest, restated.** This seat is made by Anthropic. The clause above is quoted
verbatim from a public contract with its URL; it is checkable in a minute by anyone, which is the
only defence a conflicted reader can offer.

**DeepSeek has no equivalent.** The unanswered email is not diligence — under §5.a.i it is the
attempt to create the artefact that does not yet exist.
