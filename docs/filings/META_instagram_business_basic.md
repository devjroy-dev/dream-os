...
**2c · Which account — the one open in this packet.**
> **OPEN, and the founder's alone:** DEV440's Instagram professional account is not named
> anywhere on the tree. The recording needs a real professional account whose grid can be shown
> to a stranger. The founder names it, or nominates
> `MAKEUPBYSWATIROY` **with her consent obtained and recorded** — her grid appears in a video
> Meta keeps.
>
> If neither is available, a professional account created for the purpose is legitimate under
> Meta's own guidance, provided 2b's six posts are real images the founder holds the rights to.
> This seat does not choose; it names the fork once.
...
| 2 | Vendor enters her phone number and taps to receive the code | `Vendors sign in with their own phone number. No Facebook login.` | 8s |
...
| 4 | Tapping through to the portfolio screen; the portfolio is visibly empty or thin | `Her portfolio. This is what couples see. It is empty.` | 8s |
| 5 | The **Connect Instagram** control, tapped slowly and clearly | `She taps Connect Instagram to bring her own work across.` | 6s |
...
| 8 | The grid of her own Instagram media rendering; she selects several; taps **Import** | `Her own Instagram media, read with this permission. She chooses which to import.` | 20s |
| 9 | The portfolio now populated; then the public storefront page showing the same images | `The imported photos are now her portfolio, live on the page couples see.` | 18s |
| 10 | Back on the portfolio screen, the **Disconnect** control shown and tapped; the connection gone | `She can disconnect at any time. The token is deleted.` | 10s |
...
a data-handling reviewer looks for, and thirty seconds of showing it costs less than an appeal.
...
IG professional account used: <HANDLE> · app role: Developer, Active
